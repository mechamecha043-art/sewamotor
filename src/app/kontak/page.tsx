...
export const metadata: Metadata = {
  ...
  description:
    'Hubungi Rajawali Motorcycle Rental Jakarta & Tangerang. WhatsApp: 0811-9899-232, Email: rentalmotorjakarta@gmail.com, Instagram: 08119899232. FAQ rental motor: syarat, harga, area layanan, cara pembayaran.',
  alternates: {
