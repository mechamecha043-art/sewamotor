...
const steps = [
  {
    ...
    step: '01',
    title: 'Pilih Motor',
    description: 'Pilih motor yang sesuai kebutuhan dan budget Anda.',
  },
  {
    icon: MessageCircle,
    step: '02',
    title: 'Hubungi WhatsApp',
    description: 'Hubungi kami via WhatsApp untuk konfirmasi ketersediaan.',
  },
  {
    icon: FileCheck,
    step: '03',
    title: 'Verifikasi Data',
    description: 'Siapkan KTP dan KK untuk proses verifikasi.',
  },
  {
    icon: Truck,
    step: '04',
    title: 'Motor Diantar',
    description: 'Motor diantarkan langsung ke lokasi Anda.',
  },
];

export default function HowToRent() {
  return (
    <section id="cara-rental" className="py-20 md:py-28 relative overflow-hidden">
